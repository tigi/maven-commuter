                    ...
                    dbc.Row([
                       ...
                       dbc.Col([
                           ...
                           dcc.Dropdown(
                               ...
                               value='vperc',clearable = False, style={'backgroundColor':'#383838', 'color':'white'}
               ),
                           ], className = ""),
                        dbc.Col([
                            dcc.Dropdown(
                                ...
                                value='All' ,clearable = False, style={'backgroundColor':'#383838', 'color':'white'}
                ),
                            ],  className = ""),



                       ], className = 'justify-content-end ', style={'marginBottom':'2rem', 'padding':'2rem'}),
